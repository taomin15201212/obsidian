...
```Plain
javascript [typescript](https://baidu.com) 
```
...
![jpg](https://www.nginx.cn/wp-content/uploads/2020/03/qrcode_for_gh_82cf87d482f0_258.jpg)
...
![svg](https://markdown.com.cn/images/i-am-svg.svg)
...
注：支持图片 _**拖拽和截图粘贴**_ 到编辑器中，仅支持 https 的图片，图片粘贴到微信时会自动上传微信服务器。
...
有人认为在[大前端时代](https://en.wikipedia.org/wiki/Front-end_web_development)的背景下，移动端开发（Android、IOS）将逐步退出历史舞台。

[全栈工程师](是指掌握多种技能，并能利用多种技能独立完成产品的人。)在业务开发流程中起到了至关重要的作用。
...
<span style="display:block;text-align:left;color:orangered;">橙色居右</span>
...
- 歌词经理 [wechat-fromat](https://github.com/lyricat/wechat-format)
